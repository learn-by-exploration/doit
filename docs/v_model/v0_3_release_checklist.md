...
| `________` | _tbd_ | _tbd_ | _tbd (328+)_ | v0.3e: release build. **Both are debug-signed** (CN=Android Debug) because no `android/key.properties` is set in this dev env — the v0.3b fallback design. The user re-runs `flutter build apk --release` (or `appbundle --release`) with the keystore env vars set to get a release-signed artifact.<br>APK artifact: `build/app/outputs/flutter-apk/app-release.apk` (52.7 MB) — SHA-256 `1447ad7a2d838bf24cf98b45f0ac5b3dc9b0793eaeb31bf5aaed47ad9e48a818`.<br>AAB artifact: `build/app/outputs/bundle/release/app-release.aab` (52.2 MB) — SHA-256 `2e7e6b0b84e360e06f4f51c2c68a70887c44b1b820a46d6cb806a3678d6e1588`.<br>Debug-cert SHA-256: `1fd9295da2808d76f97c41b06b718454ba694a210b6e62584fa8c6b894dc288a` (CN=Android Debug) — the v0.3b fallback, not the user's upload key. |
